...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fqdn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14715&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fqdn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fqdn` can be installed with:

```
conda install fqdn
```

It is possible to list all of the versions of `fqdn` available on your platform with:
